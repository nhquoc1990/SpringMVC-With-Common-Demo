package com.ids.springmvc.controller;
...
import com.ids.common.springmvc.service.StudentService;
...
public class MyController {
	 ...
	 */
	@RequestMapping(value = { "/delete-{code}-student" }, method = RequestMethod.POST)
